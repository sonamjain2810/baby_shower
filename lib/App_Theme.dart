...
class AppTheme {
  ...
  static Color? _lightPrimaryVariantColor = Colors.pink[300];
  static const Color _lightSecondaryColor = Colors.grey;
  static const Color _lightOnPrimaryColor = Colors.white;
  static Color? _lightPrimaryIconThemeColor = Colors.cyan[600];
  static const Color _lightButtonTextColor = Colors.white;
  static Color? _lightButtonColor = Colors.pink[300];
  ...
  static Color? _lightCardColor = Colors.cyan[600];
